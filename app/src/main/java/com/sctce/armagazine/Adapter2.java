...
public class Adapter2 extends RecyclerView.Adapter<Adapter2.MagPageHolder> {
    ...
    public Adapter2(Context mCtx, List<MagPage> MagPageList) {
        this.mCtx = mCtx;
    ...
    public MagPageHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.magrecyclerserach, parent,false);
    ...
    class MagPageHolder extends RecyclerView.ViewHolder  {
       ...
       // RoundedImageView cardbg;
        ...
        public MagPageHolder(View itemView) {
            ...
            articleName = itemView.findViewById(R.id.articleText);
            authorName = itemView.findViewById(R.id.authorText);
           // cardbg = itemView.findViewById(R.id.cardbg);
            authimg=itemView.findViewById(R.id.authorCircle);
